...
from helper import get_log_filename, validate_log_id, \
    ...
    get_total_flight_time, get_flight_mode_changes, ULogException, \
    get_airframe_name
...
class ThreeDHandler(tornado.web.RequestHandler):
    ...
    def get(self, *args, **kwargs):
        ...
        template = _ENV.get_template(THREED_TEMPLATE)
        self.write(template.render(
...
class RadioControllerHandler(tornado.web.RequestHandler):
    ...
    def get(self, *args, **kwargs):
        ...
        template = _ENV.get_template(RADIO_CONTROLLER_TEMPLATE)
        self.write(template.render())
